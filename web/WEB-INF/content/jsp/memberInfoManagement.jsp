...
<%--&lt;%&ndash;<div id ="capStatus" style="visibility: hidden"><font color="red">已打开大写锁定</font></div>&ndash;%&gt;--%>
<%--<br>--%>
...
<br/>
<form id="fetchAllMember">
</form>
<button onclick="fetchAllMember()">获取所有面试者信息</button>
</body>
<%--<script>--%>
